    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "default_tag",
                    models.CharField(blank=True, default="latest", max_length=128),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "devices",
                    models.ManyToManyField(
                        blank=True, related_name="container_networks", to="dcim.device"
                    ),
                ),
                (
                    "prefixes",
                    models.ManyToManyField(
                        blank=True, related_name="container_networks", to="ipam.prefix"
                    ),
                ),
                (
                    "tags",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "devices",
                    models.ManyToManyField(
                        blank=True, related_name="container_pods", to="dcim.device"
                    ),
                ),
                (
                    "infra_container",
